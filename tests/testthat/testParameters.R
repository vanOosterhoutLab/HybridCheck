...
test_that("comparrison settings reference object sets and returns settings correctly.", {
  ...
  compSettings <- HybRIDS:::ComparrisonSettings$new(dna)
  ...
  expect_equal(compSettings$Groups, list())
  ...
  expect_error(compSettings$changeMethod(4L))
  expect_error(compSettings$changeMethod(c(1L, 2L, 3L)))
  expect_error(compSettings$changeMethod(c(2L, 3L)))
  compSettings$changeMethod(c(1L, 2L))
  expect_equal(compSettings$Method, c(1L, 2L))
  ...
  expect_error(compSettings$setGroups("Hi"))
  expect_error(compSettings$setGroups(list(c("Seq1"), c("Seq90", "Seq5"))))
  compSettings$setGroups(list(c("Seq1", "Seq2", "Seq3"), c("Seq4", "Seq5", "Seq6"), c("Seq7", "Seq8", "Seq9", "Seq10")))
  compSettings$decideAcceptedTriplets(dna)
