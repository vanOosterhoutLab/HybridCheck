...
With the above line a new HybRIDS object was created and assigned it to a variable "MyAnalysis".
...
To generate a graphic of the recombination signal for a givn set of triplets, the `plotTriplet` method is used.
