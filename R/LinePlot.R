...
plot.similarities <- function(x, leg, bpannotate, bpfreq, labfontsize, legfontsize, bpfixedxaxis=F) {
  ...
  if(bpannotate==TRUE && bpfixedaxis == FALSE) {
