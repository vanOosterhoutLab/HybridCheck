...
echo sLinkFile = "%APPDATA%\Microsoft\Windows\Start Menu\Programs\HybridCheck\HC.lnk" >> %SCRIPT%
echo Set oLink = oWS.CreateShortcut(sLinkFile) >> %SCRIPT%
echo oLink.TargetPath = "%HOME%\HybridCheck\HC.bat" >> %SCRIPT%
echo oLink.WorkingDirectory = "%HOME\HybridCheck" >> %SCRIPT%
echo oLink.IconLocation = "%HOME%\HybridCheck\HC.icl, 0" >> %SCRIPT%
